...
import { Plus, Edit, Trash2, Save, Eye, Briefcase, MapPin, Clock, DollarSign, User, Mail, Calendar } from "lucide-react";
...
export function CareerPageCMS() {
  ...
  const updateJobPosting = (id: number, field: string, value: any) => {
  ...
  const updateProgressSkill = (index: number, field: string, value: any) => {
  ...
  const updateCircularSkill = (index: number, field: string, value: any) => {
  ...
  const updateCultureMetric = (index: number, field: string, value: any) => {
