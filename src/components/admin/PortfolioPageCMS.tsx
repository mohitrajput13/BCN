...
import { Plus, Edit, Trash2, Save, Eye, Globe, ExternalLink, User, Calendar } from "lucide-react";
...
export function PortfolioPageCMS() {
  ...
  const [relatedProjectsSection, setRelatedProjectsSection] = useState({
  ...
  const updatePortfolioItem = (id: number, field: string, value: any) => {
